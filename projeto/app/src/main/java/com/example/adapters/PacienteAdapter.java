...
public class PacienteAdapter extends BaseAdapter {
    ...
    private final List<PacienteBean> list;
    private Context context;

    public PacienteAdapter(List<PacienteBean> list, Context context){
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PessoaBean pesBean = (PessoaBean) DBhelp.selectById(PessoaBean.class, ((PacienteBean) getItem(position)).getPessoa());
